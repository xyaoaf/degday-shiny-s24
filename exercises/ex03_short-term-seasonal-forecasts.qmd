...
## 2. Find the Station ID

The Open-Meteo queries locations by longitude and latitude. 
...
## 3. Determine which Weather Forecast end point (i.e., model) to use

    [https://open-meteo.com/en/docs](https://open-meteo.com/en/docs)

We will use the **US NOAA GFS** weather model. More info at:

    [https://open-meteo.com/en/docs/gfs-api](https://open-meteo.com/en/docs/gfs-api)
...
Sometimes degree day model makes predictions beyond the next week. If you want to provide estimated degree days for the rest of the season (which are admittedly less accurate), 
...
- using modeled data is preferable to simply averaging measurements  
